...
function TodayCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onMouseEnter: e => {
      e.currentTarget.style.boxShadow = t.dark ? '0 4px 20px rgba(0,0,0,0.5)' : '0 4px 16px rgba(0,0,0,0.10)';
    ...
    onClick: onLock,
    title: locked ? 'Unlock quote' : 'Lock quote',
    style: {
      width: 30,
      height: 30,
      borderRadius: 8,
  ...
  }, quote.quote), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: t.textMuted,
      marginTop: 10,
...
function TodayScreen({
  ...
  const t = useTheme();
  const S = makeS(t);
  const todayFull = todayQuotes.map(tq => ({
    ...allQuotes.find(q => q.id === tq.id),
    locked: tq.locked
  })).filter(Boolean);
  return /*#__PURE__*/React.createElement("div", {
    style: S.screen
    ...
    style: S.body
  }, todayFull.map((q, i) => /*#__PURE__*/React.createElement(TodayCard, {
    key: q.id + i,
    quote: q,
    locked: q.locked,
    onLock: () => onLock(i),
  ...
  }, /*#__PURE__*/React.createElement(IconRefresh, null), " New Set"))));
}