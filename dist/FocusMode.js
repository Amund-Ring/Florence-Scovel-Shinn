...
function FocusMode({
  ...
  const handlePointerUp = () => {
    if (Math.abs(offset) > 60) {
      if (offset < 0) goTo(idx + 1);else goTo(idx - 1);
    }
    setDragStart(null);
    setOffset(0);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: onClose,
    style: iconBtn()
  }, /*#__PURE__*/React.createElement(IconX, null)), /*#__PURE__*/React.createElement("button", {
  ...
  }, quotes.map((_, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    onClick: () => goTo(i),
    style: {
      width: 36,
  ...
  }, /*#__PURE__*/React.createElement(IconChevronLeft, null)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      color: t.textSecondary,
      fontWeight: 500
    }
  }, idx + 1, " / ", quotes.length), /*#__PURE__*/React.createElement("button", {
    onClick: () => goTo(idx + 1),
    style: iconBtn({
      width: 40,
      height: 40,
